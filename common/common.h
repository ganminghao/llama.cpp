...
struct common_params {
    ...
    int32_t n_prompts             =     1; // number of prompts to load from prompt file for performance test
    ...
    size_t      vram_budget          = 0;  // gpu ram budget for loading neurons in sparkinfer              // NOLINT
